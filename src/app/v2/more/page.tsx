 ...
 */
export default function MoreV2Page() {
  ...
  return (
    <Screen>
      ...
      <div className="mt-7">
        ...
        <Rows className="mt-2">
          {/* The planner is not redrawn — v1 owns it. Routed straight to the mode
              rather than through a stub that would only forward. */}
          <Row icon={<Route strokeWidth={1.5} />} label={t("trip")} value="v1" href="/map?mode=plan" />
          <Row
