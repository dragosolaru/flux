...
export const V2_SCREENS: V2Screen[] = [
  ...
  { key: "map", label: "map", href: "/v2/map", legacy: "/map", done: true },
  { key: "trip", label: "trip", href: "/v2/trip", legacy: "/map?mode=plan", done: true },
  { key: "chargers", label: "chargers", href: "/v2/chargers", legacy: "/charging-map", done: true },
  ...
  { key: "documents", label: "documents", href: "/v2/documents", legacy: "/documents", done: true },
  ...
  { key: "login", label: "login", href: "/v2/login", legacy: "/login", done: true },
];
